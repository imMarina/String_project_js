...
tasks.forEach((task) => {
  ...
  <div class="task-${task.id} task">
    ...
    <div class="input-form">
      <label class="input-text" for="input"></label>
...
const input9 = task9.querySelector("#input"); // поиск по id
const btn9 = task9.querySelector(".btn");
const result9 = task9.querySelector('.result');
